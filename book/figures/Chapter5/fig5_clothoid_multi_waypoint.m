...
p = referencePathFrenet([0 -0.2; 0 -0.1; qs(1:2); qg(1:2); 1 0.1; 1 0.2], DiscretizationDistance=0.01);
figure
p.show;
axis equal
xlim([-0.05 1.05])
...
legend(["Lead-in and lead-out","Path","Heading","","Start pose","Goal pose"], Location="eastoutside")
grid on
