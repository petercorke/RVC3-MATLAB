...
cam = CentralCamera('image', im1);
cam.plot_epiline(F', m.inlier.subset(30).p2, 'y');
...
idisp(im1)
plot_point(m.inlier.subset(20).p1, 'w*', 'textcolor', 'w', 'printf', {'%.1f', z});
...
e = sum( vecnorm( [p1-m2.p1 p2-m2.p2] ) )
