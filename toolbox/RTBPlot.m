...
classdef RTBPlot
    ...
    methods (Static)
        ...
        function th = install_teach_panel(name, robot, q, opt)
            ...
            teachhandles.q = q;
            T6 = robot.fkine(q);
            if isnumeric(T6) && isequal(size(T6), [3 3])
                T6 = se2(T6);
            elseif isnumeric(T6) && isequal(size(T6),[4 4])
                T6 = se3(T6);
            end
             
            
            if isa(T6, 'se2')
                T6 = se3(blkdiag(T6.rotm, 1), [T6.trvec 0]);
            end
            T6 = T6.tform;
            ...
            if opt.d_2d
                uicontrol(panel, 'Style', 'text', ...
                    'Units', 'normalized', ...
                    'BackgroundColor', bgcol, ...
                    'Position', [0.05 1-5*height 0.3 height], ...
                    'FontUnits', 'normalized', ...
                    'FontSize', 0.6, ...
                    'HorizontalAlignment', 'left', ...
                    'String', 'Yaw:');
                ...
                teachhandles.t6.r(1) = uicontrol(panel, 'Style', 'text', ...
                    'Units', 'normalized', ...
                    'Position', [0.4 1-5*height 0.6 height], ...
                    'FontUnits', 'normalized', ...
                    'FontSize', 0.8, ...
        ...
        function record_callback(~, handles)
        ...
        function opt = plot_options(robot, optin)
            ...
            if isnan(reach)
                ...
                reach = max( vecnorm( reshape(opt.workspace, [2 3]) ) ) / 2;
            end
